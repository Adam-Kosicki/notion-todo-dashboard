...
export type { PlanningWeekSummary } from "@/lib/server/repository";
...
export type BoardPayload = {
  ...
  // Phase 3 completion: the owner's persisted (or suggested-default) planning timezone - see
  // lib/server/queries.ts's getOwnerTimezone. Same optionality rationale as weekProgress above.
